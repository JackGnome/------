...
import store.jackgnome.djarenaservice.utils.getOrNull
...
class ProductController {
    ...
    fun get(@PathVariable id: String): ProductDto {
        return getOrNull(id)?.let(productService::getById) ?: productService.getByVendorCode(id)
    }
    ...
    @ResponseStatus(HttpStatus.OK)
    fun getSearchFilters(): ProductSearchFilterDto {
        return productSearchService.getFilters()
    }
